...
function validate()
{
	var doDisp=document.forms["gen"]["doDisp"].value;	

	if(doDisp=="" ||doDisp==null )
	{
		document.getElementById("daterror").innerHTML=" Enter a valid customer id";
		document.getElementById("daterror").style.color="red";
		return false;
	}
	else{
