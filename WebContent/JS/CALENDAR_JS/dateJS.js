...
var SpanBorderColor = "#CCA383"; //Calendar border color
var MonthYearColor = "#cc0033"; //Font Color of Month and Year in Calendar header
var WeekHeadColor = '#F07121'; //Background Color in Week header
var SundayColor = "#CCA383"; //Background color of Sunday
var SaturdayColor = "#CCA383"; //Background color of Saturday
var WeekDayColor = "#FFEDA6"; //Background color of weekdays
var TodayColor = "#ffbd35"; //Background color of today
var SelDateColor = "#819FF7"; //Backgrond color of selected date in textbox
var YrSelColor = "#cc0033"; //color of font of Month-Year selector.Applies only for Arrow navigation
var HoverColor = "#819FF7"; //color of cell background when mouse move over
var DisableColor = "#D8D8D8"; //color of disabled cell
var CalBgColor = "#FFFFFF"; //Background color of Calendar window not cell

var StartYear = 2011; //First selectable year
var EndYear = 1; // The offset last year of pickable date. If current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var DisableafterToday = true; //Make date before today unclickable
var imageFilesPath = "../IMAGES/CALENDAR_IMAGES/"; //Path of date time picker image files relative to HTML page.
...
function RenderCssCal(bNewCal) {
    ...
    winCalData = "<span style='cursor:pointer; color:black'>";
    ...
    for (i = 0; i < 7; i += 1) {
        vCalHeader += "<td style='background-color:" + WeekHeadColor + ";width:" + CellWidth + "px;color:#000000' class='calTD'>" + WeekDayName[i].substr(0, WeekChar) + "</td>";
    }
    ...
    for (j = 1; j <= Cal.GetMonDays(); j += 1) {
        ...
        vDayCount = vDayCount + 1;
        //added version 2.1.2
        if (DisableafterToday === true && ((j > dtToday.getDate()) && (Cal.Month === dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Month > dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Year > dtToday.getFullYear()))) {
