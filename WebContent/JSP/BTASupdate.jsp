...
<div id='main'>
<fieldset><legend><%=resourceBundle.getString("updateCustomerDetailsByAdmin")%></legend>
<form name="f1" method="post" action="BTASServlet" onsubmit="return customeridcheck()"><input
	type="hidden" name="option" value="updatebyadmin"></input>
<table border=0 cellspacing=10 cellpadding=10 align="center">
	<tr>
		<td><label><%=resourceBundle.getString("customerId")%></label></td>
		<td><input type="text" name="cid" maxlength="6"></input><span id="iderror"></span></td>
	</tr>
	<tr>
