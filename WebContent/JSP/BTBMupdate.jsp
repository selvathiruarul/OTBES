...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/JS/updatevalidation.js"> </script>
...
<form name="gen" action="BTBMServlet" onsubmit="return validate()"
	method="post"><input type="hidden" name="option" value="update1"></input>
<center>
<h2><b><%=resourceBundle.getString("updateBill")%></b></h2>
</center>
<h4><b><%=resourceBundle.getString("enterTheConnectionNumber")%></b></h4>
<label><%=resourceBundle.getString("connectionNumber")%></label> <input
	type="text" name="conNo" maxlength="8"
	onKeyPress="return isNumberKey(event)"> <br></br>
<span id="conerror"> </span> <br>
<br>

<center><input type="submit" name="submit"
	value="<%=resourceBundle.getString("updateBill")%>" class="button"></input></center>
</form>
</fieldset>
</div>
</div>
