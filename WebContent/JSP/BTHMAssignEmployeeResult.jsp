...
<fieldset><legend><%=resourceBundle.getString("assignTicketToEmployee") %></legend> 
<%=resourceBundle.getString("ticketId")%> <%=request.getAttribute("ticketid") %> <%=resourceBundle.getString("isAssignedToEmployeeId") %>  <%=request.getAttribute("employeeid") %>
</fieldset>
</div>
</div>
</div>
