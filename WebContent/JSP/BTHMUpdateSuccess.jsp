...
<center>
<%=resourceBundle.getString("employeeDetailsAreUpdatedSuccessfully") %> !!
<br>
<br>
<input type="button" class="button"  value="<%=resourceBundle.getString("anotherUpdate")%>" onClick="self.location='BTHMUpdateEmployee.jsp'" />
</center>
</fieldset>
