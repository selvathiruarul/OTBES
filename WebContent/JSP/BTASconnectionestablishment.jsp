...
<div id="main"><input type="hidden" name="option"
	value="geneartedconnnumber" />
<fieldset><legend><%=resourceBundle.getString("connectionNumberIsGenerated")%></legend>
<table>
	<tr>
		<td align="left"><label><%=resourceBundle.getString("connectionNumber")%></label></td>
		<td align="left"><input type="text" name="number"
			value=<%out.println(conn.getConnectionNo());%> readonly="readonly" /></td>
	</tr>
</table>
</fieldset>
</div>
