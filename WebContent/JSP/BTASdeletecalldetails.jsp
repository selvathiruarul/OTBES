...
<div id="main">
<fieldset><legend><%=resourceBundle.getString("deleteCallDetails")%></legend>
<form name="form1" method="post" action="BTASServlet"
	onsubmit="return validate()">


<center>
<p><label><%=resourceBundle.getString("connectionNumber")%> </label> <input name="connectionNo"
	type="text" id="connectionNum" maxlength="8"/><span id="error"></span></p>

<p><input class="button" type="submit" name="Submit" value="<%=resourceBundle.getString("submit")%>"/>
<input class="button" type="reset" name="Submit2" value="<%=resourceBundle.getString("reset")%>" /> <input
	name="option" type="hidden" id="option" value="deletecalls" /></p>
</center>
