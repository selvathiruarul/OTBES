...
<div id="main">
<form name="form1" method="post" action="BTASServlet?option=generatereportcalldetails&currentpage=0&noofrecperpage=4"
	onsubmit="return validate()">
<fieldset><legend><label><%=resourceBundle.getString("viewCallDetails")%></label></legend> <input
	type="hidden" name="option" value="generatereportcalldetails" />
<table border=0 cellspacing=10 cellpadding=10>
	<tr>
		<td align="left"><label><%=resourceBundle.getString("connectionNumber")%></label></td>
		<td align="left"><input name="connectionNo" maxlength="8" type="text"
			id="connectionNum" /><span id="error"></span></td>
	</tr>
	<tr>
		<td align="left"><input class="button" type="submit" name="Submit"
			value="<%=resourceBundle.getString("submit")%>" class="button"></input></td>

		<td align="left"><input class="button" type="reset" name="Submit2"
			value="<%=resourceBundle.getString("reset")%>" class="button"></input></td>
	</tr>
</table>
</fieldset>
</form>
