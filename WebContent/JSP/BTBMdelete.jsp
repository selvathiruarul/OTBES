...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/JS/deletevalidation.js"> </script>
...
<form name="gen" action="BTBMServlet" onsubmit="return validate()"
	method="post"><input type="hidden" name="option" value="delete">
<label><%=resourceBundle.getString("billId")%></label>&nbsp;&nbsp;&nbsp;<input
	type="text" name="billid" maxlength="6"
	onKeyPress="return isNumberKey(event)"></input> <br></br><span id="bilerror">
</span> <br>

<center><input type="submit"
	value=<%=resourceBundle.getString("submit")%> class="button"></center>
</form>
</fieldset>
</div>
</div>
