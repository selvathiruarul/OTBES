...
<title>Ticket Updated Successfully - Bharat Tele Services</title>
...
<div id='main'>
<p align="right"><a href="<%=request.getContextPath()%>/JSP/BTHMUpdateRegisteredTicket.jsp"><b>BACK</b></a></p>
<fieldset><legend><%=resourceBundle.getString("ticketDetails") %></legend> 
<%=resourceBundle.getString("theTicketHasBeenUpdatedSuccessfully") %>!!!
</fieldset>
</div>
</div>
</div>
