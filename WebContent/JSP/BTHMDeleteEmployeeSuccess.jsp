...
<br>
<br>
<%=resourceBundle.getString("employee")%>(<%= request.getAttribute("employeeid")%>) leftTheHelpDeskTeam..
<br>
<br>

<input type="button" class="button"  value="Back" onClick="self.location='BTHMDelete.jsp'" />
</center>
</div>
