...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/JS/filenamecheck.js"></script>
<script type="text/javascript"
...
<div id='main'>
<fieldset><legend><%=resourceBundle.getString("uploadProofByAdmin")%></legend>
<div id="mandatory"><%=resourceBundle.getString("allFieldsAreMandatory")%></div>
<form name="view" method="post" onsubmit="return validate()"
	action="BTASServlet"><input type="hidden" name="option"
	value="uploadproof"></input>
<table>
	<tr>
		<td align="left"><label><%=resourceBundle.getString("customerId")%></label></td>
		<td align="left"><input type="text" name="cid" readonly="readonly"
			value=<%=customer.getCustomerID()%>></input></td>
	</tr>
	<tr>
		<td align="left"><label><%=resourceBundle.getString("idProof")%></label></td>
		<td align="left"><input type="file" name="idp"
			value=<%=customer.getIdProof()%>></input><span id="idperror">
		</span></td>
	</tr>
	...
	<tr>
		...
		<td align="left"><input type="file" name="addp"
			value=<%=customer.getAddressProof()%>></input><span id="addperror">
		</span></td>
	</tr>
