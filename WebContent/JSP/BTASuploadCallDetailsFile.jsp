...
<div id="main">
<fieldset><legend><%=resourceBundle.getString("uploadCallDetails")%></legend>


<form method="post"
	action="UploadServlet"
	onsubmit="return validate()" enctype="multipart/form-data" name="form1">

<input type="hidden" name="option" value="upload"/>
<table border=0 cellspacing=10 cellpadding=10>
	<tr>
		<td align="left"><label><%=resourceBundle.getString("uploadCallDetails")%></label></td>
		<td align="left"><input type="file" name="file"></input><span
			id="error"></span></td>
	</tr>
	<tr>
		...
		<td align="left"><input type="reset" name="Submit" value="<%=resourceBundle.getString("reset")%>"
