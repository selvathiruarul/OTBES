...
<title>Delete Registered Ticket - Bharat Tele Services</title>
...
<div id='main'>
<form name="namedeleteticket" onsubmit="return validatedeleteForm()" action="BTHMServlet">
<%
	session.setAttribute("page", "viewdeletepage");
%>
...
<table border="0" cellpadding="10" cellspacing="10">
	<tr>
		...
		<td ALIGN="left"><input type="text" name="ticketid" size="40" class="input" maxlength="6" onKeyPress="return isNumberKey(event)" AUTOCOMPLETE="OFF">
