...
<title>View Registered Ticket - Bharat Tele Services</title>
...
<div id='main'>
<form name="nameviewticket"	onsubmit="return validateviewForm()" action="BTHMServlet">
<%
	session.setAttribute("page", "viewTicketpage");
%>
<p id="mandatory">* Mandatory</p>
<p align="right"><a href="<%=request.getContextPath()%>/JSP/profile.jsp"><b>BACK</b></a></p>
<fieldset><legend><%=resourceBundle.getString("viewTicket") %></legend>
<table border="0" cellpadding="10" cellspacing="10">

	<tr>
		<td ALIGN="left"><label><%=resourceBundle.getString("ticketId") %>:*</label></td>
		<td ALIGN="left"><input class="input" type="text" name="ticketid" size="40" maxlength="6" onkeypress="return isNumberKey(event)" AUTOCOMPLETE="OFF">
