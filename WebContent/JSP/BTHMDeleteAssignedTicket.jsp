...
<div id="main">
<form name="DeleteTicket" method="post" onsubmit="return ticketIdValidate()" action="BTHMServlet">
<fieldset>
<p id="mandatory">* Mandatory</p>
<p align="right"><a href="<%=request.getContextPath()%>/JSP/profile.jsp"><b>BACK</b></a></p>
<legend><%=resourceBundle.getString("deleteAssignedTicket") %></legend>
<p><label><%=resourceBundle.getString("enterTicketId") %>*</label><input type="text" id="ticketId1" name="ticketid" maxlength="6" onKeyPress="return isNumberKey(event)"/></p>
<p><input type="submit" value="<%=resourceBundle.getString("deleteTicket") %>" class="button"/></p>
