...
<div id='main'>
<form name="f1" method="post" action="BTASServlet"
	onsubmit="return customeridcheck()"><input type="hidden" name="option"
	value="viewbyadmin"></input>
...
<table border=0 cellspacing=10 cellpadding=10>
	...
	<tr>
		<td align="left"><input class="button" type="submit" value="Submit"></input></td>
		<td align="left"><input class="button" type="reset" value="Reset"></input></td>
	</tr>
</table>
</fieldset>
</form>
