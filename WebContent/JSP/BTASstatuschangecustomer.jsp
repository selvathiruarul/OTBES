...
<form name="f1" method="post" action="BTASServlet" onsubmit="return customeridcheck()"><input
	type="hidden" name="option" value="statuschangecustomer"></input>
<table border=0 cellspacing=10 cellpadding=10 align="center">
	...
	<tr>
		<td align="left"><input type="submit" class="button" value="<%=resourceBundle.getString("submit")%>"></input></td>
		<td align="left"><input class="button" type="reset" value="<%=resourceBundle.getString("reset")%>"></input></td>
</table>
