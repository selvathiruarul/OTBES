...
<title> Ticket Raised Successfully - Bharat Tele Services</title>
...
%>
<p align="right"><a href="<%=request.getContextPath()%>/JSP/BTHMNewTicket.jsp"><b><%=resourceBundle.getString("clickHereToCreateNewTicket") %></b></a></p>
<fieldset><legend><%=resourceBundle.getString("ticketDetails")%></legend> 
<center><%=resourceBundle.getString("ticketHasBeenRaisedSuccessfully")%>!!!<br><%=resourceBundle.getString("ticketIdIs") %>: </center>
<center>
<%
	out.print(bthmTicketVo.getTicketId());
%>
</center>
</fieldset>
</div>
