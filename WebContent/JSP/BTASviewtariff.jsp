...
<div id="main">
<fieldset><legend><%=resourceBundle.getString("viewTariff")%></legend>

<form action="BTASServlet"><input type="hidden" name="option"
	value="view"></input> <%
		ArrayList<TariffVO> viewlist =(ArrayList<TariffVO>)request.getAttribute("tarifftype");
	%>
<table align="left" cellpadding="10" cellspacing="10">
	...
	<tr>
		<td align="left"><input class="button" type="submit" value="<%=resourceBundle.getString("view")%>"></td>
