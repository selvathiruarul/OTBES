...
<div id='main'>
<p align="right"><a
	href="<%=request.getContextPath()%>/JSP/BTBMdelete.jsp"><b>Delete
Another Bill</b></a></p>
<fieldset><legend><%=resourceBundle.getString("billGeneration")%></legend>
<h3><b><%=resourceBundle
					.getString("acknowledgementForBillDeletion")%></b></h3>
<%=resourceBundle.getString("theBillIsDeletedSuccessfully")%></fieldset>
</div>
</div>
</div>
</body>
