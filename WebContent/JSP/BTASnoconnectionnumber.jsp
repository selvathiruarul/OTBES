...
<h2><%=resourceBundle.getString("connectionIsNotAvailableForThatCustomer")%></h2>
<div id="Button">
<a style="text-decoration:none" href="<%=request.getContextPath()%>/JSP/BTASadconn.jsp">Back To Add connection</a>
</div>
