...
<div id='main'>
<p align="right"><a
	href="<%=request.getContextPath()%>/JSP/BTBMRaise.jsp"><b>Back</b></a></p>
<fieldset><legend><%=resourceBundle.getString("billDispute")%></legend>
<%
	BTBMVo vo = (BTBMVo) request.getAttribute("DisputeId");
	if (vo.getCount() == 0) {
%> <br />
<br />
<br />
...
<%=resourceBundle
								.getString("dearCustomer,PleaseCheckYourCustomerIdAndBillItemId")%>
<br></br>
<br></br>
<%=resourceBundle
								.getString("note,OnlyOnceADisputeCanBeRaisedForAParticularBillItemId")%>
<%
	} else {
%> <br />
<br />
...
<table>
	<tr>
		<td><%=resourceBundle.getString("dateOfRaise")%>: <%=vo.getDate()%>
		</td>
	</tr>
</table>
<br />
...
<%=resourceBundle
								.getString("yourDisputeRaisedSuccessfullyYourDisputeIdIs")%>
<b> <%=vo.getDisputeId()%> <%
 	}
 %> </b></fieldset>
</div>
