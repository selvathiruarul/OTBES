...
<form name="updateTicket" method="post" action="BTHMServlet" onSubmit="return updateTicketValidate()" >
<%session.setAttribute("page","updatepage"); %>
<p id="mandatory">* Mandatory</p>
<p align="right"><a href="<%=request.getContextPath()%>/JSP/profile.jsp"><b>BACK</b></a></p>
<fieldset>
<legend><%=resourceBundle.getString("updateAssignedTicketDetails") %></legend>
<table border="0">
<tr>
...
<tr><td></td>
<td><input type="submit" name="Submit" value="<%=resourceBundle.getString("submit") %>" class="button" ></input>
</td>
</tr>
