...
<div id='main'>
<p align="right"><a
	href="<%=request.getContextPath()%>/JSP/BTBMView1.jsp"><b>Make
Payment for Another Connection</b></a></p>
<fieldset><legend><%=resourceBundle.getString("billPayment")%></legend>
<form action="BTBMServlet">
<h1 align="center"><%=resourceBundle.getString("paidSuccessfully")%>....!</h1>
